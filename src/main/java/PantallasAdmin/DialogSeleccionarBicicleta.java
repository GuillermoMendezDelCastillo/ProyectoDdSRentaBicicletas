 ...
 * @author PC Gamer
 */
public class DialogSeleccionarBicicleta extends javax.swing.JDialog {

    /**
     * Creates new form SeleccionarBicicleta
     */
    public DialogSeleccionarBicicleta(java.awt.Frame parent, boolean modal,JFrame p) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        PanelCompraBicis c=new PanelCompraBicis(p);
        showPanel(c);
    }
