 ...
 * @author PC Gamer
 */
public class DialogInfoBici extends javax.swing.JDialog {

    /**
     * Creates new form InfoBici
     */
    public DialogInfoBici(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogInfoBici.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogInfoBici dialog = new DialogInfoBici(new javax.swing.JFrame(), true);
