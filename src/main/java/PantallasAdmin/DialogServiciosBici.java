 ...
 * @author PC Gamer
 */
public class DialogServiciosBici extends javax.swing.JDialog {

    /**
     * Creates new form ServiciosBici
     */
    public DialogServiciosBici(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogServiciosBici.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogServiciosBici dialog = new DialogServiciosBici(new javax.swing.JFrame(), true);
